<template>
    <div class="mx-auto p-6 bg-black opacity-90 text-white sticky top-0 z-10 font-bold">
        <nav class="flex items-center justify-between">
            <NuxtLink to="/" class="cursor-pointer flex items-center duration-300 hover:text-xl">
                <img
            ...
            <ul class="sm:flex items-center justify-between hidden">
                <li>
                    <NuxtLink
                        class="block p-1 mr-2 cursor-pointer duration-300 hover:scale-110"
                        :class="{ 'bg-slate-300 text-black rounded-sm': currentPage === '/about' }"
                        to="/about">
                        品牌故事
                    </NuxtLink>
                </li>
                <li>
                    <NuxtLink
                        class="block p-1 mr-2 cursor-pointer duration-300 hover:scale-110"
                        :class="{ 'bg-slate-300 text-black rounded-sm': currentPage === '/products' }"
                ...
                <li>
                    <NuxtLink
                        class="relative block p-1 mr-2 duration-300"
                        :class="{ 'bg-slate-300 text-black rounded-sm': currentPage === '/cart' }"
                        to="/cart">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="white"
    ...
    <ul
        ...
        <li>
            <NuxtLink class="block mb-2 cursor-pointer duration-300 hover:scale-110" to="/about"> 品牌故事 </NuxtLink>
        </li>
        <li>
            <NuxtLink
                class="block mb-2 cursor-pointer duration-300 hover:scale-110"
