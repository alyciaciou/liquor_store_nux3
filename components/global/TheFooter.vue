    ...
    <footer class="p-6 bg-black text-white text-center">
        <div class="flex justify-center h-full mb-4">
            <div class="mr-10 flex flex-col items-center h-[33%]">
                ...
                <NuxtLink class="inline-block duration-300 hover:scale-125" to="/about">品牌故事</NuxtLink>
            </div>
            ...
            <div class="mr-10 flex flex-col items-center h-[33%]">
                ...
                <ul>
                    <li
                        v-for="(type, index) in footerProductTypes"
                        :key="type"
                        :class="{ 'mb-2': index < footerProductTypes.length - 1 }">
                        <NuxtLink
                            class="inline-block duration-300 hover:scale-125"
                            :to="{ path: '/products', query: { type } }">
                            {{ type }}
                        </NuxtLink>
                    </li>
                </ul>
        ...
        <div class="h-[20%]">
            ...
            <p>Liquor Store © 2024 COPYRIGHT</p>
        </div>
    </footer>
</template>

<script setup lang="ts">
    const footerProductTypes = ['威士忌', '葡萄酒', '香檳', '氣泡酒'];
</script>
